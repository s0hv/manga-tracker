        ...
        return (
          <div className={classes.editCell}>
            {!row.beingEdited ? (
              ...
              <>
                <IconButton name='save' onClick={() => onStopEdit(false, row, state.rowEditStates[row.id], inst)}>
                  <SaveIcon />
                </IconButton>
                <IconButton name='cancel' onClick={() => onStopEdit(true, row, state.rowEditStates[row.id], inst)}>
                  <CancelIcon />
                </IconButton>
              </>
            )}
