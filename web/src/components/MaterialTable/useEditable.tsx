 ...
 */
export function defaultOnSaveRow<TData extends RowData>(state: Record<string, any>, { row }: MaterialCellContext<TData, any>) {
  Object.keys(state).forEach(key => {
    (row.original as any)[key] = state[key];
...
function useStuff<TData extends RowData>(table: MaterialTableInstance<TData>) {
  const {
