...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <Typography paragraph>This is the Privacy Policy for the service Manga Tracker accessible from https://manga.gachimuchi.men</Typography>
      <Typography paragraph>At Manga tracker, accessible from https://manga.gachimuchi.men, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Manga tracker and how we use it.</Typography>
      ...
      <Typography paragraph>Manga tracker follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting {"services'"} analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp and referring/exit pages. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking {"users'"} movement on the website, and gathering demographic information.</Typography>

      <Typography variant='h4'>Third Party Privacy Policies</Typography>

      <Typography paragraph>Manga {"tracker's"} Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Typography>

      <Typography paragraph>You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the {"browsers'"} respective websites.</Typography>
      ...
      <Typography paragraph>Manga tracker does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</Typography>

      <Typography variant='h4'>Consent</Typography>

      <Typography paragraph>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</Typography>
    </Container>
  );
};
