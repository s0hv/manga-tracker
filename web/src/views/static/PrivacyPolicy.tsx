...
export function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <Typography component='p'>This is the Privacy Policy for the service Manga
        Tracker accessible from https://manga.gachimuchi.men
      </Typography>
      <Typography component='p'>At Manga tracker, accessible from
        https://manga.gachimuchi.men, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Manga tracker and how we
        use it.
      </Typography>
      <Typography component='p'>
        Manga Tracker does not collect any data of users who have not signed up
        except for preferences such as selected theme. This data is stored
      ...
      <Typography component='p'>
        ...
        Only the necessary data is stored to remember the users selected
        preferences.
        The user can modify or remove these preferences at any time.
      </Typography>

      <Typography component='p'>
        Users who have signed up may at any time delete or request a copy of
        their data stored in the service
        from https://manga.gachimuchi.men/profile. Users without an account
        registered
      ...
      <p>If you have additional questions or require more information about our
        ...
        manga-tracker@gachimuchi.men
      </p>

      <Typography variant='h4'>Log Files</Typography>

      <Typography component='p'>Manga tracker follows a standard procedure of
        ...
        stamp and referring/exit pages. These are not linked to any information
      ...
      <Typography component='p'>Manga tracker's Privacy Policy does not apply to
      ...
      <Typography component='p'>You can choose to disable cookies through your
      ...
      <Typography component='p'>Another part of our priority is adding
        protection for children while using the internet. We encourage parents
        and guardians to observe, participate in, and/or monitor and guide their
        online activity.
      </Typography>

      <Typography component='p'>Manga tracker does not knowingly collect any
      ...
      <Typography component='p'>By using our website, you hereby consent to our
