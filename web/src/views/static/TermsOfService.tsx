...
export function TermsOfService() {
  return (
    ...
    >
      ...
      <Typography component='p'>This website is operated by Manga Tracker.
        Throughout the site, the terms “we”, “us” and “our” refer to Manga
        Tracker. Manga Tracker offers this website, including all information,
      ...
      <Typography component='p'>We reserve the right to refuse service to anyone
        for any reason at any time.
      </Typography>

      <Typography component='p'>You understand that your content, may be
      ...
      <Typography component='p'>The headings used in this agreement are included
        for convenience only and will not limit or otherwise affect these
        Terms.
      </Typography>

      <Typography variant='h4'>SECTION 2 - ACCURACY, COMPLETENESS AND TIMELINESS
        OF INFORMATION
      </Typography>

      <Typography component='p'>We are not responsible if information made
      ...
      <Typography component='p'>This site may contain certain historical
      ...
      <Typography variant='h4'>SECTION 3 - MODIFICATIONS TO THE SERVICE AND
        PRICES
      </Typography>

      <Typography component='p'>We reserve the right at any time to modify or
        discontinue the Service (or any part or content thereof) without notice
        at any time.
      </Typography>

      <Typography component='p'>We shall not be liable to you or to any
      ...
      <Typography component='p'>We may provide you with access to third-party
        tools over which we neither monitor nor have any control nor
        input.
      </Typography>

      <Typography component='p'>You acknowledge and agree that we provide access
      ...
      <Typography component='p'>Any use by you of the optional tools offered
      ...
      <Typography component='p'>We may also, in the future, offer new Services
      ...
      <Typography component='p'>Certain content, products and Services available
        via our Service may include materials from third-parties.
      </Typography>

      <Typography component='p'>Third-party links on this site may direct you to
      ...
      <Typography component='p'>We are not liable for any harm or damages
      ...
      <Typography variant='h4'>SECTION 6 - USER COMMENTS, FEEDBACK AND OTHER
        SUBMISSIONS
      </Typography>
      ...
      <Typography component='p'>
        ...
        <RouteLink to='/privacy_policy' aria-label='Privacy policy'>Privacy
          Policy
        </RouteLink>
      </Typography>

      <Typography variant='h4'>SECTION 8 - ERRORS, INACCURACIES AND
        OMISSIONS
      </Typography>
      ...
      <Typography component='p'>
        ...
        and to change or update information if any information in the Service or
        on any related website is inaccurate at any time without prior notice.
      </Typography>

      <Typography component='p'>We undertake no obligation to update, amend or
      ...
      <Typography component='p'>In addition to other prohibitions as set forth
      ...
      <Typography variant='h4'>SECTION 10 - DISCLAIMER OF WARRANTIES; LIMITATION
        OF LIABILITY
      </Typography>

      <Typography component='p'>We do not guarantee, represent or warrant that
        your use of our service will be uninterrupted, timely, secure or
        error-free.
      </Typography>

      <Typography component='p'> We do not warrant that the results that may be
        obtained from the use of the service will be accurate or
        reliable.
      </Typography>

      <Typography component='p'>You agree that from time to time we may remove
        ...
        In no case shall Manga Tracker, our directors, officers, employees,
      ...
      <Typography component='p'>You agree to indemnify, defend and hold harmless
        Manga Tracker and our parent, subsidiaries, affiliates, partners,
      ...
      <Typography component='p'>In the event that any provision of these Terms
      ...
      <Typography component='p'>The obligations and liabilities of the parties
        incurred prior to the termination date shall survive the termination of
        this agreement for all purposes.
      </Typography>

      <Typography component='p'>These Terms of Service are effective unless and
      ...
      <Typography component='p'>The failure of us to exercise or enforce any
        right or provision of these Terms of Service shall not constitute a
        waiver of such right or provision.
      </Typography>

      <Typography component='p'>These Terms of Service and any policies or
      ...
      <Typography component='p'>These Terms of Service and any separate
        agreements whereby we provide you Services shall be governed by and
        construed in accordance with the laws of Finland.
      </Typography>

      <Typography variant='h4'>SECTION 16 - CHANGES TO TERMS OF
        SERVICE
      </Typography>

      <Typography component='p'>You can review the most current version of the
        Terms of Service at any time at this page.
      </Typography>

      <Typography component='p'>We reserve the right, at our sole discretion, to
      ...
      <Typography component='p'>Questions about the Terms of Service should be
        sent to us at manga-tracker@gachimuchi.men.
      </Typography>
    </Container>
  );
}
